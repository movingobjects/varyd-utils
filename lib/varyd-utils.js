...
var Span = function () {
  ...
  _createClass(Span, [{
    ...
    key: "mapFromSpan",
    value: function mapFromSpan(val, fromSpan) {
    ...
    key: "mapToSpan",
    value: function mapToSpan(val, toSpan) {
      var clamp = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
...
function ptAroundCircle(rad, perc) {
  ...
  var angle = perc * maths.TAO - Math.PI / 2,
...
exports.getIndexSpan = getIndexSpan;
...
var _Span = __webpack_require__(2);
...
exports.Vec = exports.Span = exports.Rect = exports.text = exports.random = exports.maths = exports.geom = exports.arrays = undefined;
...
var _geom = __webpack_require__(3);
...
var _random2 = __webpack_require__(0);

var _random = _interopRequireWildcard(_random2);
...
var Vec = function () {
  ...
  _createClass(Vec, [{
    ...
    value: function random(minX, maxX, minY, maxY) {
      return new Vec(_random.num(minX, maxX), _random.num(minY, maxY));
    }
  }, {
    key: "fromPts",
...
exports.QUOTE_R = exports.QUOTE_L = undefined;
